  ...
  return (
    ...
    overflow-x-auto px-4'>
        ...
        <div className='flex gap-4 pb-5'>
            {/* Add story Card */}
            <div onClick={()=>setShowModal(true)} className='rounded-lg shadow-sm min-w-30 max-w-30 max-h-30 aspect-
            ...
            {/* Story Cards */}
            {
                stories.map((story,index)=> (
                    ...
                    to-purple-600 hover:from-indingo-700 hover:to-purple-800
                    active:scale-95`}>
                        <img src={story.user.Profile_picture} alt="" 
                        className='absolute size-7 top-3 left-3 z-10 rounded-full
                        ring ring-gray-100 shadow'/>
                        <p className='absolute top-10 left-3 text-white/30 text-sm
                        truncate max-w-24'>
                            {story.content}
                        </p>
                        ...
                        </p>
                        {
                            ...
                            w-full object-cover hover:scake-110 transition
