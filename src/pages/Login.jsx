        ...
        lg:pl-40'>
           ...
           <div>
                <div className='flex items-center gap-3 mb-4 max-md:mt-10'>
                    <img src={assets.groupusers} alt="" className='h-8 md:h-10' />
                    <div>
                        <div className='flex'>
                        ...
                        <p>Trusted by 7M+ developers</p>
                    </div>
                </div>
                <h1 className='text-3xl md:text-6xl md:pb-2 font-bold bg-gradient-to-r
                from-black to-indingo-800 bg-clip-text '>
                    Beyond friends, we truly connect
                </h1>
                <p className='text-xl md:text-3xl text-indigo-900 max-w-72
                md:max-w-md'>
                    Join the global community - on Connecto.         
                </p>
           </div>
